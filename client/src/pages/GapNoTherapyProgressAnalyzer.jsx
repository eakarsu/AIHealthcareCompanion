...
// Auto-generated page for: No therapy-progress analyzer

export default function GapNoTherapyProgressAnalyzer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-therapy-progress-analyzer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No therapy-progress analyzer</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No therapy-progress analyzer</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No therapy-progress analyzer'}
        </button>
      </form>
