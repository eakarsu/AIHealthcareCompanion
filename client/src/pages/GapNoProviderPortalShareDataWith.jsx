...
// Auto-generated page for: No provider portal (share data with doctors)

export default function GapNoProviderPortalShareDataWith() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-provider-portal-share-data-with', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No provider portal (share data with doctors)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No provider portal (share data with doctors)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No provider portal (share data with doctors)'}
        </button>
      </form>
