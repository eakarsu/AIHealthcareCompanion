...
// Auto-generated page for: No symptom-analyzer endpoint

export default function GapNoSymptomAnalyzerEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-symptom-analyzer-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No symptom-analyzer endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No symptom-analyzer endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No symptom-analyzer endpoint'}
        </button>
      </form>
