...
// Auto-generated page for: No insurance information module

export default function GapNoInsuranceInformationModule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-insurance-information-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No insurance information module</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No insurance information module</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No insurance information module'}
        </button>
      </form>
