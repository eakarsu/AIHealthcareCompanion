...
// Auto-generated page for: Preventive health roadmap by age, family history, and risk f

export default function CfPreventiveHealthRoadmapByAgeFamily() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-preventive-health-roadmap-by-age-family', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Preventive health roadmap by age, family history, and risk f</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Preventive health roadmap by age, family history, and risk factors.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Preventive health roadmap by age, family history, and risk f'}
        </button>
      </form>
