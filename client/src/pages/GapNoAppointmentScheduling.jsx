...
// Auto-generated page for: No appointment scheduling

export default function GapNoAppointmentScheduling() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-appointment-scheduling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No appointment scheduling</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No appointment scheduling</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No appointment scheduling'}
        </button>
      </form>
