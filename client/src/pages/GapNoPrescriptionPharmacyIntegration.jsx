...
// Auto-generated page for: No prescription / pharmacy integration

export default function GapNoPrescriptionPharmacyIntegration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-prescription-pharmacy-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No prescription / pharmacy integration</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No prescription / pharmacy integration</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No prescription / pharmacy integration'}
        </button>
      </form>
