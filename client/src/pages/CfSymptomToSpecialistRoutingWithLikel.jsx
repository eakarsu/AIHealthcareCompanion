...
// Auto-generated page for: Symptom-to-specialist routing with likelihood-ranked suggest

export default function CfSymptomToSpecialistRoutingWithLikel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-symptom-to-specialist-routing-with-likel', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Symptom-to-specialist routing with likelihood-ranked suggest</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Symptom-to-specialist routing with likelihood-ranked suggestions.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Symptom-to-specialist routing with likelihood-ranked suggest'}
        </button>
      </form>
