...
// Auto-generated page for: No medication-interaction checker

export default function GapNoMedicationInteractionChecker() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-medication-interaction-checker', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No medication-interaction checker</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No medication-interaction checker</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No medication-interaction checker'}
        </button>
      </form>
