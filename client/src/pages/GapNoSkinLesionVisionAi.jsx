...
// Auto-generated page for: No skin-lesion vision AI

export default function GapNoSkinLesionVisionAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-skin-lesion-vision-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No skin-lesion vision AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No skin-lesion vision AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No skin-lesion vision AI'}
        </button>
      </form>
